...
function visualizeProducts() {
  // 1) un ciclo, cioè, per ogni elemento della lista...

  for (let index = 0; index < productsList.length; index++) {
    const product = productsList[index];

    // 2) creo una div, avrà classe card e le varie div al suo interno
    let productDiv = `
    ...
    // Però vediamo che è un po' verboso come approccio.
